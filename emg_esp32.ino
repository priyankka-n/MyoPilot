...
What Will This Do?
Read raw EMG signals from two ADC channels.
Apply noise filtering.
Extract features (MAV, RMS, ZCR).
Send the extracted features over serial output for debugging.
*/



/*THIS CODE INPUTS FAKE EMG VALUES FOR TESTING.
 * THE AVM, RMS, ZCE work perfectly in this.
 * 
 * 
...
//this code outputs all 0.0 values for now. yet to be tested with EMG values.
#include <Arduino.h>
